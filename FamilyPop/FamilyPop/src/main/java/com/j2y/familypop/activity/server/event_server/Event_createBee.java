 ...
 */
public class Event_createBee extends BaseEvent
{
    float _x;
    float _y;
    ...
    // Parse 하고 들어와야함.
    public Event_createBee(float x, float y, String tileImageName)
    {
        super();
    ...
    public Actor_honeyBee Create_honeyBee()
    {
        Actor_honeyBee ret = null;
        ret = Activity_serverMain_andEngine.Instance.Create_honeybee(_x, _y, _tileImageName);
